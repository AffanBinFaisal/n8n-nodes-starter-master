...
const showOnlyForCustomerPortalLoanAppQueueGetAll = {
	operation: ['getAll'],
	resource: ['customerPortalLoanAppQueue'],
};

export const customerPortalLoanAppQueueGetAllDescription: INodeProperties[] = [
	{
		displayName: 'Application No',
		name: 'applicationNo',
		type: 'string',
		default: '',
		displayOptions: { show: showOnlyForCustomerPortalLoanAppQueueGetAll },
